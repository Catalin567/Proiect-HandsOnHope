  ...
  return (
    <div className="container-to-animate">
      ...
      <p>
        ...
        aflate în nevoie redirecționând o parte din impozitul pe venit, fără
      ...
      <form className="donation-form" onSubmit={handleSubmit}>
        ...
        <div className="checkboxes">
          <label>
            <input type="checkbox" name="acord_politica" value="on" required />{" "}
            Sunt de acord cu politica de confidențialitate a SNCR *
          </label>
          <br />
          <br />
          <label>
            <input type="checkbox" name="acord_anaf" value="on" required /> Sunt
            de acord cu colectarea datelor cu caracter personal și trimiterea
            acestora către ANAF *
          </label>
        </div>
