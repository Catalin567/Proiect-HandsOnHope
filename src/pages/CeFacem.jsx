...
import harta from "../images/harta-romaniei.png";
const CeFacem = () => {
  return (
    <div>
      <Navigation />
      ...
      <div className="chestii-tot">
        ...
        <section className="map-section">
          <h2 className="section-title">Harta Nevoilor din România - * Nefunctional Momentan</h2>
          <div className="harta-romaniei" style={{ backgroundImage: `url(${harta})` }}></div>
        </section>
